...
В утренней сводке показывается состояние магнитного поля Земли. Магнитные бури возникают, когда поток частиц с Солнца возмущает магнитосферу — возможны перебои радиосвязи и GPS, в высоких широтах — северные сияния.

Сила бурь по шкале NOAA:
• G1 — слабая
• G2 — средняя
• G3 — сильная
• G4 — очень сильная
...
Данные обновляются каждые 3 часа с xras.ru.
